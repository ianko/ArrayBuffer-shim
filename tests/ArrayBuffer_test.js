...
ArrayBuffer = require('../lib/ArrayBuffer').ArrayBuffer;
DataView = require('../lib/ArrayBuffer').DataView;
Uint8Array = require('../lib/ArrayBuffer').Uint8Array;
Uint32Array = require('../lib/ArrayBuffer').Uint32Array;
